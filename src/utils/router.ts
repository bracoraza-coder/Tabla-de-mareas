...
export function updateHeadForPort(port: Port) {
  ...
  const description = `Tabla de mareas de ${port.name} (${port.region}): pleamar, bajamar, coeficiente y altura del agua estimados con modelo astronómico. Previsión de surf y oleaje en vivo: swell, periodo, viento y mejor hora para surfear. Datos gratuitos.`;
