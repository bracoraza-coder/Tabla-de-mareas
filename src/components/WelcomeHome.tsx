      ...
      <div className="space-y-8">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-950 via-slate-900 to-indigo-950 border border-cyan-500/30 p-8 sm:p-12 shadow-2xl text-center">
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-5">
            ...
            {/* Prominent Search Bar inside Hero */}
            <div className="pt-2">
              <div className="flex flex-col sm:flex-row items-center gap-3 bg-slate-950/80 p-3 rounded-2xl border border-cyan-500/40 shadow-2xl backdrop-blur-md">
                <div className="relative flex-1 w-full">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3.5 bg-slate-900 border border-slate-800 focus:border-cyan-500 rounded-xl text-white placeholder-slate-400 text-sm font-medium shadow-inner outline-none transition-all"
                  />
                </div>
